    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_since', gac.models.DateTimeWithoutTZField(null=True)),
                ('valid_until', gac.models.DateTimeWithoutTZField(null=True)),
                ('external_created_at', gac.models.DateTimeWithoutTZField()),
                ('external_updated_at', gac.models.DateTimeWithoutTZField()),
