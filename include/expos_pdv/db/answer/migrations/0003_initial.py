...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='vendor_id',
            field=models.ForeignKey(db_column='vendor_id', db_constraint=False,
                                    on_delete=django.db.models.deletion.CASCADE, to='vendor.vendorstaged'),
        ),
        migrations.AddField(
            model_name='surveyfailedinserts',
            name='job_id',
            field=models.ForeignKey(db_column='job_id',
                                    on_delete=django.db.models.deletion.CASCADE, to='etl_job.etljob'),
        ),
        migrations.AddField(
