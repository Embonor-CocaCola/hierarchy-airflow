...
HIERARCHY_AIRFLOW_DATABASE_CONN_ID = 'airflow_db_conn'

HIERARCHY_SERVICE_DATABASE_CONN_ID = 'hierarchy_service_db_conn'
HIERARCHY_EXPOS_DATABASE_CONN_URI = os.environ.get('HIERARCHY_DATABASE_CONN_URI')
