...
class GetPhotosToUploadTaskGroup:
    ...
    def get_question_photos(self, ti):
        ...
        with open(f'{SQL_PATH}/maxerience_load/get_question_photos.sql', 'r') as file:
            sql = file.read()
    ...
    def build(self):
        ...
        with open(f'{SQL_PATH}/maxerience_load/get_question_ids.sql', 'r') as file:
            sql = file.read()
        ...
        with open(f'{SQL_PATH}/maxerience_load/get_non_analyzed_evaluations.sql', 'r') as file:
            sql = file.read()
