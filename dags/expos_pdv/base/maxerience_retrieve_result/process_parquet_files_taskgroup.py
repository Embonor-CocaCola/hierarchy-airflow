...
from expos_pdv.base.maxerience_retrieve_result.utils.parquet_type_metadata_map import parquet_type_metadata_map
from expos_pdv.base.utils.query_with_return import parameterized_query, copy_csv_to_table
from expos_pdv.base.utils.tasks import arrange_task_list_sequentially
from expos_pdv.config.common.settings import airflow_root_dir, SQL_PATH
from expos_pdv.config.maxerience_retrieve_result.settings import MRR_REST_BASE_URL, MRR_SAS_KEY
...
class ProcessParquetFilesTaskGroup:
    ...
    def process_parquet_files(self, parquet_type):
        with open(
                f'{SQL_PATH}/maxerience_retrieve_result/get_unprocessed_parquets.sql',
                'r',
        ) as file:
            sql = file.read()
        ...
        for parquet in unprocessed_parquets:
            ...
            with open(
                    f'{SQL_PATH}/maxerience_retrieve_result/update_parquet_file_as_processed.sql',
                    'r',
            ) as file:
                sql = file.read()
